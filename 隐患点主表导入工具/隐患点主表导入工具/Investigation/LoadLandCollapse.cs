    ...
    public class LoadLandCollapse
    {
        ...
        public virtual string InsertData(string landFilePath, string comFilePath)
        {
            ...
            for (int i = 0; i < landTable.Rows.Count; i++)
            {
                try
                {
                    LandCollapse landCollapse = GetLandCollapse(landTable.Rows[i], landTable.Columns);
        ...
        public LandCollapse GetLandCollapse(DataRow row, DataColumnCollection columns)
        {

            LandCollapse landCollapse = new LandCollapse();
